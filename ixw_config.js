module.exports = {
	name: "tnm", 
	description : "TNM web frontend project based on IXW",
	namespace: "TNM",
	version: "1.0",
...
//			margin:8, // margin for each images in spirit file, default is 8
			classPrefix : "line", // defualt is line
			path : "line" // default is "line"
		},{
//			margin:8, // margin for each images in spirit file, default is 8
			classPrefix : "topo", // defualt is line
			path : "topo" // default is "line"
		},{
//			margin:8, // margin for each images in spirit file, default is 8
			classPrefix : "logo", // defualt is line
			path : "logo" // default is "line"
		}]
	},
	deploy: {
	},
	release :{
//		jsUrl : "http://localhost/tnm/_rel/js",
//		imagesUrl : "http://localhost/tnm/_rel/img",
//		cssUrl : "http://localhost/tnm/_rel/css"
	},
	...
	grunt : {
		...
		concat: {
			...
			project :{
				src : [
					"src/ixw/lib/const.js", "src/ixw/lib/tnmconst.js","src/ixw/lib/shareData.js","src/ixw/lib/util.js",
					"src/nvlib/model.js","src/ixw/grid/cols.js",
					"src/nvlib/ui.js","src/nvlib/grid.js","src/nvlib/nvgrid.js",
					"src/ixw/lib/tree.js","src/nvlib/dialog.js",
					"src/ixw/lib/dashboard.js","src/ixw/lib/sites.js","src/ixw/lib/racks.js","src/ixw/lib/topo.js","src/ixw/lib/ui.js",
					"src/ixw/lib/jquery-migrate-1.2.1.js","src/ixw/lib/jquery.jqprint-0.3.js",
					"src/ixw/grid/grid.js",
	
					"src/ixw/_entry/index.js",
					"src/ixw/_err/index.js",
					"src/ixw/_sys/index.js",
					"src/ixw/_device/dialog.js",
					"src/ixw/_device/index.js",
					"src/ixw/_fault/index.js",
					"src/ixw/_monitor/index.js",
					"src/ixw/index.js"],
